...
class AzureIoTHub
{
    ...
    //
    // Note: this connection string is specific to the device "rugro-yyc01". To configure other devices,
    ...
    //    iothub-explorer monitor-events --login HostName=SCDemo-IotHub.azure-devices.net;SharedAccessKeyName=service;SharedAccessKey=uukfFV5e9lKCryyQ/bjIabfX9fiUUcsP6ncyAuYi5ug= "rugro-yyc01"
    //
    ...
    public static async Task SendDeviceToCloudMessageAsync()
    {
        CreateClient();
#if WINDOWS_UWP
        var str = "{\"deviceId\":\"rugro-yyc01\",\"messageId\":1,\"text\":\"Hello, Cloud from a UWP C# app!\"}";
#else
        var str = "{\"deviceId\":\"rugro-yyc01\",\"messageId\":1,\"text\":\"Hello, Cloud from a C# app!\"}";
#endif
